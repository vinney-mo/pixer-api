...
return [
    ...
    */
    ...
    'stripe' => [
        ...
        'success_url'    => env('STRIPE_SUCCESS_URL', url('/stripe/payment-success')),
        'cancel_url'     => env('STRIPE_CANCEL_URL', url('/stripe/payment-cancel')),
        'frontend_success_url' => env('STRIPE_FRONTEND_SUCCESS_URL', '/checkout/payment-success'),
        'frontend_cancel_url'  => env('STRIPE_FRONTEND_CANCEL_URL', '/checkout/payment-failed'),
        'frontend_callback_url' => env('STRIPE_FRONTEND_CALLBACK_URL', '/checkout/payment-failed')
    ],
